...
export const homeTranslations = {
    ...
    view: isRTL ? 'عرض' : 'View',
    messageCoach: isRTL ? 'رسالة للدكتور' : 'Message Coach',
...
export const attentionTranslations = {
    ...
    noClientsNeedAttention: isRTL ? 'لا يوجد عملاء يحتاجون اهتمام' : 'No clients need attention right now',
    errorLoadingClients: isRTL ? 'خطأ في تحميل العملاء' : 'Error loading clients',
    tapToRetry: isRTL ? 'اضغط لإعادة المحاولة' : 'Tap to retry',
};

// Appointment Section Translations
export const appointmentTranslations = {
    inProgress: isRTL ? 'جارية الآن' : 'In Progress',
    startingSoon: isRTL ? 'تبدأ قريباً' : 'Starting Soon',
    enjoyYourDay: isRTL ? 'استمتع بيومك!' : 'Enjoy your day!',
    errorLoadingAppointments: isRTL ? 'خطأ في تحميل المواعيد' : 'Error loading appointments',
    joinCall: isRTL ? 'انضمام للمكالمة' : 'Join Call',
};
...
export const profileTranslations = {
    ...
    coach: isRTL ? 'الدكتور' : 'Coach',
    dayOf: isRTL ? 'يوم من' : 'Day of',
    daysRemaining: isRTL ? 'يوم متبقي' : 'days remaining',
    messageCoach: isRTL ? 'راسل الدكتور' : 'Message Coach',
